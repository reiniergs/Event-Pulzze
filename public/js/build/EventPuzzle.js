...
var EventPuzzle = React.createClass({displayName: 'EventPuzzle',
	render : function () {
		...
		var events = renderList.map(function (event) {
 			return (
 				React.createElement(Event, {data: event, key: event.key, cb: this.removeEvent, index: event.key})
 				);
 		}.bind(this));
		return (
			React.createElement("div", {style: puzzleContainer}, 
				React.createElement(TimeLine, null), 
				React.createElement("div", {style: puzzleCSS}, 
					events
				)
			)	
			);
